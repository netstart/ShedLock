...
public class DynamoDBLockProvider implements LockProvider {
    ...
    private final DynamoDbClient table;
    ...
    public Optional<SimpleLock> lock(LockConfiguration lockConfiguration) {
        ...
        try {
            final UpdateItemResponse updateItemResponse = table.updateItem(updateItemRequest);
            assert lockUntilIso.equals(updateItemResponse.getValueForField(LOCK_UNTIL, String.class).get());
    ...
    private final class DynamoDBLock implements SimpleLock {
        ...
        public void unlock() {
            ...
            assert unlockTimeIso.equals(updateItemResponse.getValueForField(LOCK_UNTIL, String.class).get());
